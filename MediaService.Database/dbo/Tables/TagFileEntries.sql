CREATE TABLE [dbo].[TagFileEntries] (
    ...
    CONSTRAINT [FK_dbo.TagFileEntries_dbo.ObjectEntries_FileEntry_Id] FOREIGN KEY ([FileEntry_Id]) REFERENCES [dbo].[ObjectEntries] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_dbo.TagFileEntries_dbo.Tags_Tag_Id] FOREIGN KEY ([Tag_Id]) REFERENCES [dbo].[Tags] ([Id]) ON DELETE CASCADE
);
