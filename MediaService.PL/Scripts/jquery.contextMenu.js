    ...
    var // currently active contextMenu trigger
        ...
        handle = {
            ...
            mouseup: function(e) {
                // show menu
                var $this = $(this);
                if ($this.data("contextMenuActive") &&
                    $currentTrigger &&
            ...
            layerClick: function(e) {
                ...
                setTimeout(function() {
                        var $window;
                        var triggerAction = ((root.trigger === "left" && button === 0) ||
                        ...
                        if (root.hideOnSecondTrigger &&
                            triggerAction &&
                            root.$menu !== null &&
                            typeof root.$menu !== "undefined") {
            ...
            prevItem: function(e) {
                ...
                while ($prev.hasClass(root.classNames.disabled) ||
                    $prev.hasClass(root.classNames.notSelectable) ||
                    $prev.is(":hidden")) {
                    if ($prev.prev().length) {
                        $prev = $prev.prev();
                    } else {
            ...
            nextItem: function(e) {
                ...
                while ($next.hasClass(root.classNames.disabled) ||
                    $next.hasClass(root.classNames.notSelectable) ||
                    $next.is(":hidden")) {
                    if ($next.next().length) {
                        $next = $next.next();
                    } else {
        ...
        op = {
            show: function(opt, x, y) {
                ...
                if (opt.autoHide) {
                    ...
                    $(document).on("mousemove.contextMenuAutoHide",
                        function(e) {
            ...
            create: function(opt, root) {
                ...
                $.each(["callbacks", "commands", "inputs"],
                    function(i, k) {
                        opt[k] = {};
                        if (!root[k]) {
                            root[k] = {};
                            ...
                            $.each([opt, root],
                                function(i, k) {
                                    ...
                                    if ($.isFunction(item.callback) &&
                                        (typeof k.callbacks[key] === "undefined" || typeof opt.type === "undefined")) {
                            ...
                            default:
                                $.each([opt, root],
                                    function(i, k) {
                                        ...
                                        // doesn't overwrite callbacks of root elements if the name is the same.
                                        if ($.isFunction(item.callback) &&
                                        (typeof k.callbacks[key] === "undefined" ||
                                            typeof opt.type === "undefined")) {
                                            k.callbacks[key] = item.callback;
                                        }
                                    });
                                createNameNode(item).appendTo($t);
                            ...
                            if (item.icon) {
                                if ($.isFunction(item.icon)) {
                                    ...
                                    if (typeof(item.icon) === "string" && item.icon.substring(0, 3) === "fa-") {
                                        ...
                                        item._icon =
                                            root.classNames.icon + " " + root.classNames.icon + "--fa fa " + item.icon;
                                    } else {
                                        item._icon =
                                            root.classNames.icon + " " + root.classNames.icon + "-" + item.icon;
                                    }
                                }
            ...
            update: function(opt, root) {
                ...
                opt.$menu.children().each(function() {
                    var $item = $(this),
                        ...
                        item = opt.items[key],
                        disabled = ($.isFunction(item.disabled) && item.disabled.call($trigger, key, root)) ||
                            item.disabled === true,
                        visible;
            ...
            processPromises: function(opt, root, promise) {
                ...
                function finishPromiseProcess(opt, root, items) {
                    ...
                    root.positionSubmenu.call(opt.$node,
                        opt.$menu); // positionSubmenu, will only do anything if user already hovered over menu item that just got new subitems.
                }
