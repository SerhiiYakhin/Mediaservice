CREATE TABLE [dbo].[ObjectEntryApplicationUsers] (
    ...
    CONSTRAINT [FK_dbo.ObjectEntryApplicationUsers_dbo.ObjectEntries_ObjectEntry_Id] FOREIGN KEY ([ObjectEntry_Id]) REFERENCES [dbo].[ObjectEntries] ([ObjectEntryId]) ON DELETE CASCADE
);
